...
var sharedMethods = require('./sharedMethods.js');
var consoleWriter = require('./consoleWriter.js');
var buildMethodsModule = require('./buildMethods.js');
var lockMethodsModule = require('./lock.js');
var schemaScriptMethodsModule = require('./schemaScriptMethods.js');
var routinesMethodsModule = require('./routinesMethods.js');
...
module.exports = function(options, done) {
    ...
    var solidLine  = '----------------------------------------------------------------------';
    var brokenLine = '|- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - ';
    var buildMethods = buildMethodsModule(dbServer, dbDatabase, options.database);
    var lockMethods = lockMethodsModule(dbDatabase);
    var schemaScriptMethods = schemaScriptMethodsModule(dbDatabase);
    var routinesMethods = routinesMethodsModule(dbDatabase, options.database);
